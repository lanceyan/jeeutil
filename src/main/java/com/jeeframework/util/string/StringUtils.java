...
public abstract class StringUtils extends com.jeeframework.util.string.apache.StringUtils {
    ...
    /**
     * 得到指定长度字符串，只包含数字，不包含0
     *
     * @param length
     * @return
     */
    public static String getRandomNumberStringNoZero(int length) { //length表示生成字符串的长度
        //        String base = "abcdefghijklmnopqrstuvwxyz0123456789";
     ...
     * @return
     */
    public static String getRandomAlphaNumericString(int length) { //length表示生成字符串的长度
        //        String base = "abcdefghijklmnopqrstuvwxyz0123456789";
        String base = "0123456789";
        Random random = new Random();
        StringBuffer sb = new StringBuffer();
    ...
    public static float getSimilarityByLevenshtein(String str1, String str2) {
        int dis = com.jeeframework.util.string.apache.StringUtils.getLevenshteinDistance(str1, str2);
